...
class EmpruntController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $emprunt->adherent = $request->input('adherent');
        ...
        //$emprunt = DB::select('livres')('UPDATE livres SET disponible = (SELECT disponible - (1))');

        DB::table('livres')
         // find your user by their email
        ->limit(1)  // optional - to ensure only one record is updated.
        ->update(array('disponible' => -1));  // update the record in the DB. 
